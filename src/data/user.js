const INFO = {
	main: {
		title: "Reactportfolio by Vishnuraj",
		name: "Vishnuraj V.",
	...
	socials: {
		...
		github: "https://github.com/VishnuvarCode",
		linkedin: "https://www.linkedin.com/in/v-vishnuraj-2002v/",
		instagram: "https://www.instagram.com/v_code_yeet/",
		stackoverflow: "https://stackoverflow.com/",
		facebook: "https://facebook.com/",
	},

	homepage: {
		title: "Full-stack web and MERN-stack developer.",
		description:
			"Experienced React Developer with 2 years of expertise in modern web applications. Proficient in HTML, CSS, JavaScript, Bootstrap, jQuery, React.js, Redux, and React Router. Skilled in RESTful API integration and state management with Redux and Context API. Knowledgeable in npm, Git, responsive design, cross-browser compatibility, web performance optimization, and Progressive Web Apps. Strong team collaborator committed to delivering high-quality software solutions and staying current with development trends.",
	},

	about: {
		title: "Hello, I'm Vishnuraj V. from Chennai, crafting tomorrow's innovations.",
		description:
			"Experienced React Developer with 2 years of expertise in modern web applications. Proficient in HTML, CSS, JavaScript, Bootstrap, jQuery, React.js, Redux, and React Router. Skilled in RESTful API integration and state management with Redux and Context API. Knowledgeable in npm, Git, responsive design, cross-browser compatibility, web performance optimization, and Progressive Web Apps. Strong team collaborator committed to delivering high-quality software solutions and staying current with development trends.",
	},
